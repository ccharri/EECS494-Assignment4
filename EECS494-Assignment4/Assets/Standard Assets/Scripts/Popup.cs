//Taken from http://wiki.unity3d.com/index.php?title=PopupList
...
//	public static bool ListLayout (ref bool showList, ref int listEntry, GUIContent buttonContent, GUIContent[] listContent,
//	                         GUIStyle listStyle) {
//		return ListLayout(ref showList, ref listEntry, buttonContent, listContent, "button", "box", listStyle);
//	}
//
//	public static bool ListLayout (ref bool showList, ref int listEntry, GUIContent buttonContent, GUIContent[] listContent,
//	                         GUIStyle buttonStyle, GUIStyle boxStyle, GUIStyle listStyle) {
