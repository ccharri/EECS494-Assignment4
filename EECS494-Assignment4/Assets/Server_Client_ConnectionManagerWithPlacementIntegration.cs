...
public class Server_Client_ConnectionManagerWithPlacementIntegration : MonoBehaviour {
	...
	void enablePlacementManager()
	{
		PlacementManagerWithNetworkIntegration placeman = this.gameObject.GetComponent<PlacementManagerWithNetworkIntegration>();
		placeman.enabled = true;
	}
